 ...
 */
public record CatalogModel(String name, String description, List<ExtensionModel> extensions) {
     ...
     */
    public CatalogModel(String name, String description, List<ExtensionModel> extensions) {
        this.name = name;
